...
if config_env() == :prod do
  ...
  #
  #     config :exfwghtblog_frontend, ExfwghtblogFrontend.Endpoint, server: true
  #
  ...
  #
  #     config :exfwghtblog_frontend, ExfwghtblogFrontend.Mailer,
  ...
  config :exfwghtblog_backend, ExfwghtblogBackend.Repo,
    url:
      System.get_env("DATABASE_URL") ||
        ...
        Please specify a PostgreSQL database URL
        """)
end
