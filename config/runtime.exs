...
#
#     PHX_SERVER=true bin/exfwghtblog start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :exfwghtblog, ExfwghtblogWeb.Endpoint, server: true
end
...
if config_env() == :prod do
  ...
  config :exfwghtblog, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
  ...
  #
  #     config :exfwghtblog, Exfwghtblog.Mailer,
...
if config_env() == :prod do
  ...
  config :exfwghtblog, Exfwghtblog.Guardian, secret_key: guardian_secret
