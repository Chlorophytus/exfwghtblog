...
config :exfwghtblog, ExfwghtblogWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "svsh57rTm7mJku0iCiPGrwzZfoU3oOwT7IsRtFR5mU/PpmoHZlYq1GCoVg7UktTg",
  watchers: [
    esbuild: {Esbuild, :install_and_run, [:exfwghtblog, ~w(--sourcemap=inline --watch)]},
    tailwind: {Tailwind, :install_and_run, [:exfwghtblog, ~w(--watch)]}
  ]
...
config :exfwghtblog, ExfwghtblogWeb.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/exfwghtblog_web/(controllers|live|components)/.*(ex|heex)$"
    ]
  ]
